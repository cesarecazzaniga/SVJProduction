...
# with command line options: SVJ/Production/python/EmptyFragment_cff.py --eventcontent RAWSIM --datatier GEN --fileout file:step0.root --conditions 140X_mcRun3_2024_realistic_v26 --beamspot DBrealistic --step GEN --geometry DB:Extended --era Run3_2024 --no_exec --mc --python_filename SVJ/Production/python/2024/step_GEN.py --no_exec
