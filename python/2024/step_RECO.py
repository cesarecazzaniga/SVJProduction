...
# with command line options: --eventcontent AODSIM --datatier AODSIM --fileout file:step0.root --conditions 140X_mcRun3_2024_realistic_v26 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:step-1.root --era Run3_2024 --no_exec --mc --python_filename SVJ/Production/python/2024/step_RECO.py --no_exec
